...
class Cook: 
    ...
    def image(self, food, index):
        cwd = os.getcwd() + '/' 
        filename = {
            Food.CORN_DOG: cwd+'food_images/corndog.jpg',
            Food.BANANA: cwd+'food_images/banana.jpg',
            Food.HAMBURGER: cwd+'food_images/hamburger.jpg',
            Food.CRAZY_HAMBURGER: cwd+'food_images/crazyhamburger.jpg',
            Food.KEBAP: cwd+'food_images/kebap.jpg',
            Food.HOTDOG: cwd+'food_images/hotdog.jpg'
        }.get(food)
        ...
        file = open(cwd+'src/res/standard.ttf', 'rb')
